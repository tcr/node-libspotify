...
/**
 * spotify callback for the unaccepted_licenses_updated event. (this is in the 12.1.103 beta version for raspberry pi and not documented anywhere I can find :)
 */
